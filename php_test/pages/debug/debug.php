...
if (!isset($_SESSION['user_id'])) {
    die('<h1>Erreur d\'accès</h1><p>Vous devez être connecté pour accéder au debug.</p><p><a href="../auth/login.php">Se connecter</a></p>');
}
...
$matchFiles = glob(DATA_PATH . '/matches/match_*.json');
